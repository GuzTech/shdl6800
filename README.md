...
- [Part 5](https://www.youtube.com/watch?v=9MMb9dSnNvo) is completed as far as the HDL and the FPGA specific code. Code for device and package specification, and pin constraints have also been implemented but needs a bit more testing. The implementations is [working](https://twitter.com/BitlogIT/status/1214352859376029696) though.
